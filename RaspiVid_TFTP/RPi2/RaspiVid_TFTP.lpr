...
begin
 ...
 argv:=AllocateCommandLine('-hf -vf --timeout 10000 --width 640 --height 480 --framerate 25 --bitrate 1200000 --preview 300,200,640,480 --output C:\camera.h264',argc);
