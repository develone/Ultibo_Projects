...
// DEFINES //////////////////////////////////////////////////////////////////
//OBJECT4DV2 int Set_Frame(int frame);
...
struct POLYF4DV2_TYP *next;   // pointer to next polygon in list??
struct POLYF4DV2_TYP *prev;   // pointer to previous polygon in list??
...
void Transform_OBJECT4DV2(OBJECT4DV2_PTR obj, MATRIX4X4_PTR mt,   
                          int coord_select, int transform_basis, int all_frames);
