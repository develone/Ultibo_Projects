...
// using 64 bit math, so as not to loose precission
  float fp_prod =  FIXP16_TO_FLOAT(fp1) * FIXP16_TO_FLOAT(fp2);
  
  return(FLOAT_TO_FIXP16(fp_prod) );
/*
...
void VECTOR2D_Add3(VECTOR2D_PTR va, 
                         VECTOR2D_PTR vb, 
                         VECTOR2D_PTR vsum)
{
...
VECTOR2D VECTOR2D_Add2(VECTOR2D_PTR va, 
                      VECTOR2D_PTR vb)
{
...
void VECTOR2D_Sub3(VECTOR2D_PTR va, 
                         VECTOR2D_PTR vb, 
                         VECTOR2D_PTR vdiff)
{
...
VECTOR2D VECTOR2D_Sub2(VECTOR2D_PTR va, 
                      VECTOR2D_PTR vb)
{
...
void VECTOR3D_Add3(VECTOR3D_PTR va, 
                  VECTOR3D_PTR vb, 
                  VECTOR3D_PTR vsum)
{
// this function adds va+vb and return it in vsum
...
VECTOR3D VECTOR3D_Add2(VECTOR3D_PTR va, 
                      VECTOR3D_PTR vb)
{
// this function adds va+vb and returns the result on 
// the stack
...
void VECTOR3D_Sub3(VECTOR3D_PTR va, 
                  VECTOR3D_PTR vb, 
                  VECTOR3D_PTR vdiff)
{
// this function subtracts va-vb and return it in vdiff
...
void VECTOR4D_Scale2(float k, VECTOR4D_PTR va)
{
// this function scales a vector by the constant k,
...
void VECTOR4D_Cross3(VECTOR4D_PTR va, 
                    VECTOR4D_PTR vb,
                    VECTOR4D_PTR vn)
{
// this function computes the cross product between va and vb
...
for (int r=0; r < 2; r++, Write_Error((char*)"\n"))
    for (int c=0; c < 2; c++)
        Write_Error((char*)"%f ",ma->M[r][c]);        
...
for (int r=0; r < 3; r++, Write_Error((char*)"\n"))
    for (int c=0; c < 3; c++)
        Write_Error((char*)"%f ",ma->M[r][c]);        
...
Write_Error((char*)"\n%s=\n",name);
for (int r=0; r < 4; r++, Write_Error((char*)"\n"))
    for (int c=0; c < 4; c++)
        Write_Error((char*)"%f ",ma->M[r][c]);        
...
int Intersect_Parm_Lines2D4(PARMLINE2D_PTR p1, PARMLINE2D_PTR p2, 
                           float *t1, float *t2)
{
...
if (!normalize)
   ...
   VECTOR3D_Normalize2(normal,&plane->n);
   } // end else
