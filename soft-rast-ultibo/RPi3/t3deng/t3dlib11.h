...
struct POLYF4DV2Q_TYP *next;   // pointer to next polygon in list??
struct POLYF4DV2Q_TYP *prev;   // pointer to previous polygon in list??
...
typedef struct BHV_NODEV1_TYP
        ...
        struct BHV_NODEV1_TYP *links[MAX_BHV_PER_NODE]; // links to children
