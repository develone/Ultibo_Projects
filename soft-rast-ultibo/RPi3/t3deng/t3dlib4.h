...
inline void MAT_TRANSPOSE_3X3PTR(MATRIX3X3_PTR m, MATRIX3X3_PTR mt) 
{ mt->M00 = m->M00; mt->M01 = m->M10; mt->M02 = m->M20;
  mt->M10 = m->M01; mt->M11 = m->M11; mt->M12 = m->M21;
  mt->M20 = m->M02; mt->M21 = m->M12; mt->M22 = m->M22; }
  

inline void MAT_TRANSPOSE_4X4PTR(MATRIX4X4_PTR m, MATRIX4X4_PTR mt) 
{ mt->M00 = m->M00; mt->M01 = m->M10; mt->M02 = m->M20; mt->M03 = m->M30; 
  mt->M10 = m->M01; mt->M11 = m->M11; mt->M12 = m->M21; mt->M13 = m->M31; 
  mt->M20 = m->M02; mt->M21 = m->M12; mt->M22 = m->M22; mt->M23 = m->M32; 
  mt->M30 = m->M03; mt->M31 = m->M13; mt->M32 = m->M22; mt->M33 = m->M33; }
...
// 2d vector functions
void     VECTOR2D_Add3(VECTOR2D_PTR va, VECTOR2D_PTR vb, VECTOR2D_PTR vsum);
VECTOR2D VECTOR2D_Add2(VECTOR2D_PTR va, VECTOR2D_PTR vb);



void     VECTOR2D_Sub3(VECTOR2D_PTR va, VECTOR2D_PTR vb, VECTOR2D_PTR vdiff);
VECTOR2D VECTOR2D_Sub2(VECTOR2D_PTR va, VECTOR2D_PTR vb);


void VECTOR2D_Scale2(float k, VECTOR2D_PTR va);
void VECTOR2D_Scale3(float k, VECTOR2D_PTR va, VECTOR2D_PTR vscaled);
...
void VECTOR2D_Normalize1(VECTOR2D_PTR va);
void VECTOR2D_Normalize2(VECTOR2D_PTR va, VECTOR2D_PTR vn);
...
// 3d vector functions
void     VECTOR3D_Add3(VECTOR3D_PTR va, VECTOR3D_PTR vb, VECTOR3D_PTR vsum);
VECTOR3D VECTOR3D_Add2(VECTOR3D_PTR va, VECTOR3D_PTR vb);

void     VECTOR3D_Sub3(VECTOR3D_PTR va, VECTOR3D_PTR vb, VECTOR3D_PTR vdiff);
VECTOR3D VECTOR3D_Sub2(VECTOR3D_PTR va, VECTOR3D_PTR vb);

void VECTOR3D_Scale2(float k, VECTOR3D_PTR va);
void VECTOR3D_Scale3(float k, VECTOR3D_PTR va, VECTOR3D_PTR vscaled);

float VECTOR3D_Dot(VECTOR3D_PTR va, VECTOR3D_PTR vb);

void     VECTOR3D_Cross3(VECTOR3D_PTR va,VECTOR3D_PTR vb,VECTOR3D_PTR vn);
VECTOR3D VECTOR3D_Cross2(VECTOR3D_PTR va, VECTOR3D_PTR vb);

float VECTOR3D_Length(VECTOR3D_PTR va);
float VECTOR3D_Length_Fast(VECTOR3D_PTR va);

void VECTOR3D_Normalize1(VECTOR3D_PTR va);
void VECTOR3D_Normalize2(VECTOR3D_PTR va, VECTOR3D_PTR vn);
...
// 4d vector functions
void     VECTOR4D_Add3(VECTOR4D_PTR va, VECTOR4D_PTR vb, VECTOR4D_PTR vsum);
VECTOR4D VECTOR4D_Add2(VECTOR4D_PTR va, VECTOR4D_PTR vb);

void     VECTOR4D_Sub3(VECTOR4D_PTR va, VECTOR4D_PTR vb, VECTOR4D_PTR vdiff);
VECTOR4D VECTOR4D_Sub2(VECTOR4D_PTR va, VECTOR4D_PTR vb);

void VECTOR4D_Scale1(float k, VECTOR4D_PTR va);
void VECTOR4D_Scale3(float k, VECTOR4D_PTR va, VECTOR4D_PTR vscaled);

float VECTOR4D_Dot(VECTOR4D_PTR va, VECTOR4D_PTR vb);

void     VECTOR4D_Cross3(VECTOR4D_PTR va,VECTOR4D_PTR vb,VECTOR4D_PTR vn);
VECTOR4D VECTOR4D_Cross2(VECTOR4D_PTR va, VECTOR4D_PTR vb);


float VECTOR4D_Length(VECTOR4D_PTR va);
float VECTOR4D_Length_Fast(VECTOR4D_PTR va);

void VECTOR4D_Normalize1(VECTOR4D_PTR va);
void VECTOR4D_Normalize2(VECTOR4D_PTR va, VECTOR4D_PTR vn);
...
void QUAT_Scale3(QUAT_PTR q, float scale, QUAT_PTR qs);
void QUAT_Scale2(QUAT_PTR q, float scale);

float QUAT_Norm(QUAT_PTR q);
float QUAT_Norm2(QUAT_PTR q);

void QUAT_Normalize2(QUAT_PTR q, QUAT_PTR qn);
void QUAT_Normalize1(QUAT_PTR q);

void QUAT_Unit_Inverse2(QUAT_PTR q, QUAT_PTR qi);
void QUAT_Unit_Inverse1(QUAT_PTR q);

void QUAT_Inverse2(QUAT_PTR q, QUAT_PTR qi);
void QUAT_Inverse1(QUAT_PTR q);
...
int Intersect_Parm_Lines2D4(PARMLINE2D_PTR p1, PARMLINE2D_PTR p2, float *t1, float *t2);
int Intersect_Parm_Lines2D3(PARMLINE2D_PTR p1, PARMLINE2D_PTR p2, POINT2D_PTR pt);
