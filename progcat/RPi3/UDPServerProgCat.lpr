...
{                                                                              }
{ This version is for Raspberry Pi 3B and will also work on a 2B.              }
{ To create a version for the A/B/A+/B+/Zero simply create a new project and   }
{ copy this code into it.                                                      }

uses

  InitUnitprogcat,     {Include InitUnit to allow us to change the startup behaviour}

  RaspberryPi3, {Include RaspberryPi3 to make sure all standard functions are included}
  Threads, ServerUnitprogcat;   {Include ServerUnit which contains the main code for our server}
